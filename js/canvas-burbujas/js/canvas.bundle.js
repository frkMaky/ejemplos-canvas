  ...
  _createClass(Particle, [{
    ...
    value: function update(particles) {
      ...
      for (var index = 0; index < particles.length; index++) {
        if (this === particles[index]) continue; // Si es la misma seguir
        if ((0,_utils__WEBPACK_IMPORTED_MODULE_0__.distance)(this.x, this.y, particles[index].x, particles[index].y) - this.radius * 2 < 0) {
          ...
          //index = -1; // Se reinicia el loop para que se vuelva a comprobar 
        }
      }
      ...
      // Mouse collision 
      if ((0,_utils__WEBPACK_IMPORTED_MODULE_0__.distance)(mouse.x, mouse.y, this.x, this.y) - this.radius * 2 < 30 && this.opacity < 0.5) {
        this.opacity += 0.2;
...
function init() {
  particles = [];
  for (var i = 0; i <= 200; i++) {
    var color = colors[(0,_utils__WEBPACK_IMPORTED_MODULE_0__.randomIntFromRange)(1, 4)];
    ...
    if (i !== 0) {
      for (var j = 0; j < particles.length; j++) {
        if ((0,_utils__WEBPACK_IMPORTED_MODULE_0__.distance)(x, y, particles[j].x, particles[j].y) - radius * 2 < 0) {
          ...
          j = -1; // Se reinicia el loop para que se vuelva a comprobar 
        }
      }
    }
