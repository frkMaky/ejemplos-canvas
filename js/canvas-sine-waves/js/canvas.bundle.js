...
gui.add(wave, 'lenght', -0.01, 0.1);
gui.add(wave, 'amplitude', -300, 300);
gui.add(wave, 'frequency', -0.01, 0.1);
gui.add(strokeColor, 'h', 0, 360);
...
gui.add(backgroundColor, 'a', 0.01, 1);
*/
var mouse = {
  x: innerWidth / 2,
  y: innerHeight / 2
  ...
  return _createClass(Object, [{
    ...
    value: function draw() {
      ...
      for (var i = 0; i < canvas.width; i++) {
        c.lineTo(i, wave.y + Math.sin(i * wave.lenght + this.increment) * wave.amplitude * Math.sin(this.increment));
      }
...
function init() {
  objects = [];
  for (var i = 0; i < 100; i++) {
    objects.push(new _Object(0, 0, 30, 'black'));
  }
}
